...
const y = require('./modulos/banco')
console.log(y)

/* for(i = 0, i < 10, i++){

    function newConta(numeroDaConta[i],tipoDeConta[i],saldo[i],titular[i]) {
        this.numeroDaConta = numeroDaConta[i]
        this.tipoDeConta = tipoDeConta[i]
        this.saldo = saldo[i]
        this.titular = titular[i]
    }
} */
